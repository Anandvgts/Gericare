...
class ConsultationDetailSection {
  final ConsultationSectionType type;
  final String title;
  final String icon;
  final SectionLayoutType? layoutType;
  final List<ConsultationRow> rows;
  final Map<String, List<String>>? groupedItems; // Old / New
  ...
  ConsultationDetailSection({
    ...
    required this.title,
    required this.icon,
    this.layoutType = SectionLayoutType.twoColumn,
    this.rows = const [],
    this.groupedItems,
  });
}
...
class ConsultationHistoryDetailsViewModel extends VGTSBaseViewModel {
  final String doctorName = "John William";
  final String speciality = "General Doctor";
  final String dateTime = "3:30 AM, Jun 22, 2025";

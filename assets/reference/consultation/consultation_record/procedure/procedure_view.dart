...
import 'package:gericare_doctor/ui/views/consultation/consultation_record/procedure/procedure_view_model.dart';
...
class ProceduresView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return ViewModelBuilder<ProceduresViewModel>.reactive(
      viewModelBuilder: () => ProceduresViewModel(),
